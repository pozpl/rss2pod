...
function PodPanel(singlePodPan){
    ...
    this.regSinglePodPanel = function(singlePodPanelObj){
    ...
    this.showUserPodcasts = function(){
        var podPanObj = this;
        ...
        podPanObj.eventConnections = dojo.query("[id^='podcastname_']").connect("onclick", function(evt){
            ...
            singlePodPan.showSinglePodData(podIndx);
        });
        /*
    ...
    this.addNewPodcast = function(formAttrs){
        var podPadObj = this;
    ...
    this.unfoldPodManagEls = function(podIndx, nodeToUnfold, ruleNode){
        var podPanObj = this;
    ...
    this.deletePodcast = function(podId){
